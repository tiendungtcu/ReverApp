...
describe('Comment e2e test', () => {
  ...
  it('should create and save Comments', async () => {
    commentUpdatePage.setCommentTitleInput('commentTitle');
    expect(await commentUpdatePage.getCommentTitleInput()).to.match(/commentTitle/);
    ...
    commentUpdatePage.setCommentCreatedDateInput('01/01/2001' + protractor.Key.TAB + '02:30AM');
    expect(await commentUpdatePage.getCommentCreatedDateInput()).to.contain('2001-01-01T02:30');
    commentUpdatePage.setCommentUpdateDateInput('01/01/2001' + protractor.Key.TAB + '02:30AM');
    expect(await commentUpdatePage.getCommentUpdateDateInput()).to.contain('2001-01-01T02:30');
