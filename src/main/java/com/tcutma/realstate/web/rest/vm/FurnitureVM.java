...
public class FurnitureVM {
    ...
    public Boolean getPropertySofa() {
        return propertySofa;
    }
    ...
    public Boolean getPropertyDiningTable() {
    ...
    public Boolean getPropertyKitchen() {
    ...
    public Boolean getPropertyCabinetKitchen() {
    ...
    public Boolean getPropertyKitchenEquipment() {
    ...
    public Boolean getPropertyWardrobe() {
    ...
    public Boolean getPropertyMakeupTable() {
    ...
    public Boolean getPropertyDesk() {
        return propertyDesk;
    }
    ...
    public Boolean getPropertyTivi() {
        return propertyTivi;
    }
    ...
    public Boolean getPropertyWashingMachine() {
    ...
    public Boolean getPropertyRefrigerator() {
    ...
    public Boolean getPropertyWaterHeater() {
    ...
    public Boolean getPropertyHeater() {
    ...
    public Boolean getPropertyAudioEquipment() {
