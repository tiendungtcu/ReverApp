    ...
    return (
      <div>
        <h2 id="category-heading">
          <Translate contentKey="riverApp.category.home.title">Categories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="riverApp.category.home.createLabel">Create new Category</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('categoryName')}>
                  <Translate contentKey="riverApp.category.categoryName">Category Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
